...
export const dict = {
  en: {
    ...
    hero: {
      ...
      category: "Category", categoryVal: "Reptiles",
      region: "Region", regionVal: "Shipping: US",
      budget: "Budget", budgetVal: "$200 – $1,000",
      cta: "Shop Now",
    },
    stories: [
  ...
  zh: {
    ...
    hero: {
      ...
      category: "类别", categoryVal: "爬行类",
      region: "配送", regionVal: "全国可发",
      budget: "预算", budgetVal: "¥1,500 – ¥8,000",
      cta: "立即选购",
    },
    stories: [
