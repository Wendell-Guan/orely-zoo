...
export const dict = {
  en: {
    ...
    hero: {
      ...
      category: "Category",
      categoryOptions: ["Suriname Horned Frog", "Reptiles", "Parrots", "Small Mammals", "Aquatic", "Arachnids"],
      region: "Region",
      regionOptions: ["Shipping: US", "Shipping: EU", "Shipping: Asia", "Pickup In-Store"],
      budget: "Budget",
      budgetOptions: ["Under $200", "$200 – $1,000", "$1,000 – $5,000", "$5,000 – $15,000", "$15,000+"],
      cta: "Shop Now",
      searching: "Searching",
    ...
    catalog: {
      ...
      sub: "Curated individuals currently in our facility — every animal comes with lineage records and a health certificate.",
      tags: { hot: "HOT", new: "NEW", rare: "RARE", flagship: "FLAGSHIP" },
      inStock: "In Stock",
      lowStock: "Only 1 left",
      sold: "Reserved",
      reserve: "Reserve",
      items: [
        { name: "Suriname Horned Frog — Mint",  species: "Ceratophrys cornuta",     price: 12800,  stock: "low",   tag: "flagship" },
        { name: "Suriname Horned Frog — Albino", species: "Ceratophrys cornuta",    price: 18600,  stock: "ok",    tag: "rare" },
        { name: "Crested Gecko — Lilly White",  species: "Correlophus ciliatus",    price: 890,    stock: "ok",    tag: "hot" },
        { name: "Ball Python — Pied Morph",     species: "Python regius",           price: 2400,   stock: "ok",    tag: "new" },
        { name: "Blue-Tongue Skink — Northern", species: "Tiliqua scincoides",      price: 680,    stock: "ok",    tag: null },
        { name: "Axolotl — Golden",             species: "Ambystoma mexicanum",     price: 220,    stock: "ok",    tag: "hot" },
        { name: "Indian Ringneck — Blue",       species: "Psittacula krameri",      price: 1100,   stock: "ok",    tag: null },
        { name: "Emperor Scorpion",             species: "Pandinus imperator",      price: 95,     stock: "ok",    tag: null },
        { name: "Green Tree Python — Biak",     species: "Morelia viridis",         price: 3500,   stock: "low",   tag: "rare" },
        { name: "Sugar Glider — Leucistic",     species: "Petaurus breviceps",      price: 780,    stock: "sold",  tag: null },
        { name: "African Pygmy Hedgehog",       species: "Atelerix albiventris",    price: 320,    stock: "ok",    tag: "new" },
        { name: "Poison Dart Frog — Azureus",   species: "Dendrobates tinctorius",  price: 260,    stock: "ok",    tag: null },
      ],
    },
    pricing: {
      ...
      plans: [
        ...
        { name: "SIGNATURE",   price: 12999, items: ["Suriname Horned Frog Flagship", "Bioactive Vivarium Build", "12-Month Premium Food", "Lifetime Veterinary Plan", "Personal Keeper Visit", "Breeder Lineage Certificate"] },
      ],
    },
    how: {
      title: "HOW IT WORKS",
    ...
    reviews: {
      ...
      list: [
        ...
        { name: "Marcus Leong",    role: "Frog Collector",   text: "Picked up a flagship Suriname horned frog — stunning pattern, perfectly hydrated on arrival, and the vivarium build they delivered was display-grade." },
        { name: "Sofia Ramirez",   role: "Vet Technician",   text: "As a working vet tech I audit every seller I buy from. Orely's husbandry logs, parasite screening, and traceability paperwork is textbook." },
      ],
    },
  ...
  zh: {
    ...
    hero: {
      ...
      category: "类别",
      categoryOptions: ["苏里南角蛙", "爬行类", "鹦鹉类", "小型哺乳", "水族", "蛛形类"],
      region: "配送",
      regionOptions: ["国内配送", "亚洲配送", "欧美配送", "到店自取"],
      budget: "预算",
      budgetOptions: ["¥1,500 以下", "¥1,500 – ¥8,000", "¥8,000 – ¥30,000", "¥30,000 – ¥100,000", "¥100,000 以上"],
      cta: "立即选购",
      searching: "正在搜索",
      resultsFor: "个匹配结果",
    },
    ...
    catalog: {
      title: "精选在售",
      sub: "目前在库个体精选 — 每只均附血统记录与健康证明。",
      tags: { hot: "热销", new: "新到", rare: "稀有", flagship: "旗舰" },
      inStock: "现货",
      lowStock: "仅剩 1 只",
      sold: "已预订",
      reserve: "预订",
      items: [
        { name: "苏里南角蛙 · 薄荷绿",    species: "Ceratophrys cornuta",     price: 89800,  stock: "low",   tag: "flagship" },
        { name: "苏里南角蛙 · 白化",       species: "Ceratophrys cornuta",     price: 128888, stock: "ok",    tag: "rare" },
        { name: "睫角守宫 · Lilly White", species: "Correlophus ciliatus",    price: 6200,   stock: "ok",    tag: "hot" },
        { name: "球蟒 · 白化拼图",         species: "Python regius",           price: 16800,  stock: "ok",    tag: "new" },
        { name: "蓝舌石龙子 · 北部种",     species: "Tiliqua scincoides",      price: 4800,   stock: "ok",    tag: null },
        { name: "六角龙 · 金化",           species: "Ambystoma mexicanum",     price: 1560,   stock: "ok",    tag: "hot" },
        { name: "月轮鹦鹉 · 蓝化",         species: "Psittacula krameri",      price: 7700,   stock: "ok",    tag: null },
        { name: "帝王蝎",                  species: "Pandinus imperator",      price: 680,    stock: "ok",    tag: null },
        { name: "绿树蟒 · 比亚克",         species: "Morelia viridis",         price: 24500,  stock: "low",   tag: "rare" },
        { name: "蜜袋鼯 · 白化",           species: "Petaurus breviceps",      price: 5460,   stock: "sold",  tag: null },
        { name: "非洲迷你刺猬",            species: "Atelerix albiventris",    price: 2240,   stock: "ok",    tag: "new" },
        { name: "箭毒蛙 · 钴蓝",           species: "Dendrobates tinctorius",  price: 1820,   stock: "ok",    tag: null },
      ],
    },
    pricing: {
      title: "套餐与价格",
      ...
      plans: [
        ...
        { name: "旗舰版", price: 128888, items: ["苏里南角蛙旗舰个体", "生态雨林缸定制", "12 个月高端饲料", "终身兽医方案", "专属饲养师上门", "血统证书与档案"] },
      ],
    },
    how: {
      title: "购买流程",
    ...
    reviews: {
      ...
      list: [
        ...
        { name: "陆鸣轩", role: "蛙类收藏",   text: "拿下一只旗舰苏里南角蛙 — 花色惊艳，到家状态水润，搭配他们做的雨林缸直接展缸级。" },
        { name: "苏可欣", role: "宠物医师",   text: "作为兽医师我会审核每一家买过的商家。这家的饲养日志、寄生虫筛查与溯源文件都是教科书级别。" },
      ],
    },
